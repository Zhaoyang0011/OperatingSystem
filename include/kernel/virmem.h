...
typedef struct kernel_virtual_memory_area_descriptor {
...
void pvmspacdesc_init(pvmspacdesc_t *);
...
extern KRL_DEFGLOB_VARIABLE(kvmemcboxmgr_t, kvmcbox_manager);
extern KRL_DEFGLOB_VARIABLE(pvmspacdesc_t, initial_pvmspacedesc);
