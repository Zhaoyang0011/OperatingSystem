...
int set_one_phymem(e820_map_t *e820, physical_memory_t *pm) {
  ...
  switch (e820->type) {
    case RAM_USABLE:ptype = PM_T_OSAPUSERRAM;
      pstype = RAM_USABLE;
      break;
    case RAM_RESERV:ptype = PM_T_RESERVRAM;
      pstype = RAM_RESERV;
      break;
    case RAM_ACPIREC:ptype = PM_T_HWUSERRAM;
      pstype = RAM_ACPIREC;
      break;
    case RAM_ACPINVS:ptype = PM_T_HWUSERRAM;
      pstype = RAM_ACPINVS;
      break;
    case RAM_AREACON:ptype = PM_T_BUGRAM;
      pstype = RAM_AREACON;
      break;
    default:break;
  }
